...
public class CCHIntentService extends IntentService
{
	...
	private tora.clevercallhandler.BluetoothHeadset mBluetoothHeadsetTora;
	...
	protected void onHandleIntent(Intent intent)
	{
		...
		if ( mHeadsetOnly )
		{
			...
			{
				mBluetoothHeadsetTora = new tora.clevercallhandler.BluetoothHeadset(this, null);
			}
		}
		...
		if ( mHeadsetOnly )
		{
			if( Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB )
			{
				...
				if ( mBluetoothHeadsetTora != null )
				{
					try {
						if ( mBluetoothHeadsetTora.isConnected(mBluetoothHeadsetTora.getCurrentHeadset()) == false )
						{
							mBluetoothHeadsetTora.close();
							return;
						}
						mBluetoothHeadsetTora.close();
					} catch(Exception e)
					{
						Log.e(TAG, "onHandleIntent/mBluetoothHeadsetTora : " + e.toString());
						return;
					}
				}
			}
